...
try {
    ...
    $stmt = $pdo->query("SELECT COUNT(*) as pending_reports FROM reports WHERE status = 'pending'");
    $pending_reports = $stmt->fetch()['pending_reports'];
} catch(PDOException $e) {
    $total_users = $total_feedback = $total_reports = $pending_reports = 0;
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Barangay Kanluran - Admin Dashboard</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-custom">
        <div class="container-fluid">
            <a class="navbar-brand text-white d-lg-none" href="admin_dashboard.php">Barangay Kanluran</a>
            ...
            <div class="row justify-content-center mb-4">
                <div class="col-lg-8">
                    <div class="card-custom p-4 text-center">
                        <h3 class="text-success mb-3">Welcome, Admin <?php echo htmlspecialchars($user['fullname']); ?>!</h3>
                        <span class="role-badge">ADMIN</span>
                        <p class="mt-3 mb-0">You have administrator privileges. You can manage feedback, reports, and projects from residents.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-3">
                    <div class="card-custom p-4 stat-card">
                        ...
                        <h3 class="text-warning mb-0"><?php echo $pending_reports; ?></h3>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4">
                <div class="col-md-3">
                    <div class="card-custom p-4 text-center h-100">
                        ...
                        <p>Review and respond to feedback from residents.</p>
                ...
                <div class="col-md-3">
                    <div class="card-custom p-4 text-center h-100">
                        ...
                        <p>Handle issue reports and update their status.</p>
                ...
                <div class="col-md-3">
                    <div class="card-custom p-4 text-center h-100">
                        ...
                        <p>Check ongoing barangay projects and events.</p>
            ...
            <div class="row justify-content-center mt-4">
                <div class="col-lg-6">
                    <div class="card-custom p-4">
                        <h5 class="text-success mb-3">Your Admin Account</h5>
                        <p><strong>Name:</strong> <?php echo htmlspecialchars($user['fullname']); ?></p>
                        <p><strong>Username:</strong> <?php echo htmlspecialchars($user['username']); ?></p>
                        <p><strong>Email:</strong> <?php echo htmlspecialchars($user['email']); ?></p>
                        <p><strong>Role:</strong> <span class="role-badge">ADMIN</span></p>
